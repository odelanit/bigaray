...
class ProductSpider(scrapy.Spider):
    ...
    start_urls = [
        'https://www2.hm.com/en_ca/men/new-arrivals/clothes/_jcr_content/main/productlisting.display.json'
        '?sort=stock&image-size=small&image=model&offset=0&page-size=174'
    ]
