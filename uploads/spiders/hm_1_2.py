...
class ProductSpider(scrapy.Spider):
    ...
    start_urls = [
        'https://www2.hm.com/en_ca/sale/shopbyproductladies/view-all/_jcr_content/main/productlisting_b48c.display.json'
        '?sort=stock&image-size=small&image=model&offset=0&page-size=1338'
    ]
